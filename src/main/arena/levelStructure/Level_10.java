...
public class Level_10 extends Level {
    ...
    public Level_10(PApplet p) {
        ...
        dialogues = new Dialogue[][] {{
            ...
            new Dialogue(p, "all monsters of the same type share a hivemind,", getPositionFromSlot(4)),
            ...
            new Dialogue(p, "You thought you were killing individual monsters", getPositionFromSlot(4)),
            new Dialogue(p, "with individual lives this whole time?", getPositionFromSlot(4)),
            ...
            new Dialogue(p, "Oh don't worry,", getPositionFromSlot(4)),
            new Dialogue(p, "a few chests are on their way.", getPositionFromSlot(4)),
            new Dialogue(p, "$!!", getPositionFromSlot(0)),
            new Dialogue(p, "...", getPositionFromSlot(2)),
